#!/usr/bin/env python3
"""
YouTube Data Extractor - Main Entry Point

This is the main entry point for the YouTube Data Extractor application.
The application has been modularized for better maintainability and scalability.

To run the application:
    python main.py

The modular application is located in the app/ directory.
"""
